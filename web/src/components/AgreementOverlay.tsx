...
export default function AgreementOverlay({ onCancel, onConfirm }: AgreementOverlayProps) {
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/45 px-6">
      <div className="flex max-h-[calc(100vh-48px)] w-full max-w-[620px] flex-col rounded-lg border border-border bg-surface-elevated shadow-xl">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-6 py-5 text-sm leading-6 text-text-secondary">
          <p className="mb-4">
            본 서비스는 업로드한 PDF 문서에서 필요한 내용을 빠르게 찾고, 표 데이터를 확인하거나 CSV로
            다운로드하며, 문서 내용 번역을 보조하기 위한 내부 업무 도구입니다. 업로드된 PDF 원본 파일은
            업로드 후 7일이 지나면 삭제됩니다.
          </p>

          <section className="mb-4">
            <h3 className="mb-2 font-semibold text-text-primary">핵심 안내</h3>
            <ul className="list-disc space-y-1 pl-5">
              <li>PDF 원본 파일, 문서 텍스트, 표 구조, 검색 및 번역 요청 내용이 처리될 수 있습니다.</li>
              <li>표 데이터는 화면에서 확인하거나 CSV로 다운로드할 수 있습니다.</li>
              <li>개인정보 또는 민감정보가 포함된 경우 탐지 가능한 항목은 마스킹 처리됩니다.</li>
              <li>업무상 보관이 필요한 결과물은 PDF 원본 삭제 전 별도 저장해주세요.</li>
            </ul>
          </section>
